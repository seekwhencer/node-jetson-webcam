    ...
    constructor(args) {
        ...
        this.encoder = {
            ...
            vp8: [
                ...
                '!', 'nvv4l2vp8enc',
                `bitrate=${this.options.bitrate * 0.9}`,
                'maxperf-enable=1',
                //'iframeinterval=100',
                'preset-level=4',
        ...
        this.preset = {
            ...
            tcp: [
                ...
                '!', `video/x-raw, format=YUY2, width=${this.options.width},height=${this.options.height}, type=video, framerate=${this.options.framerate_from || this.options.framerate}/1`,
            ...
            h264nv: [
                ...
                '-e',
                'v4l2src', `device=${this.options.device}`,
                '!', `image/jpeg,width=${this.options.width},height=${this.options.height},type=video,framerate=${this.options.framerate_from || this.options.framerate}/1`,
                '!', 'jpegdec',
                ...
                '!', 'nvvidconv',
                '!', `video/x-raw(memory:NVMM),format=NV12,width=${this.options.width},height=${this.options.height},framerate=${this.options.framerate_to || this.options.framerate}/1`,
